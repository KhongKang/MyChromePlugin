...
function showNiceInfo(n) {
    ...
    t += '<tr class="' + getClassStyle(headerInfo.response[i].statusLine) + '"><td colspan="6">',
    t += "<b>Request URL: <\/b>" + headerInfo.response[i].url + "<br />",
    t += "<\/td><\/tr>",
    t += '<tr class="warning"><td colspan="4"><b>Referer URL: <\/b>';
...
$(function () {
    ...
    chrome.webRequest.onSendHeaders.addListener(
        function (n) {
            if (capture(n.type) == 1 && captureTraffic == 1)
                headerInfo.request.push(n);
            return;
        },
        {
            urls: ["<all_urls>"],
